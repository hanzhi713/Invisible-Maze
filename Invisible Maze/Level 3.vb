Public Class Level_3
    ...
    Private Sub Level_3_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub Level_3_DoubleClick(sender As Object, e As EventArgs) Handles Me.DoubleClick
    ...
    Private Sub Level_3_KeyPress(sender As Object, e As KeyPressEventArgs) Handles Me.KeyPress
        If e.KeyChar = Chr(Keys.Back) Then
            Intermediate.Label1.Text = "Press SPACE to start the level"
            Intermediate.Show()
            Intermediate.frm = "Level3"
            Me.Close()
        End If
    End Sub
