Public Class Level_2
    ...
    Private Sub Level_2_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub Level_2_KeyPress(sender As Object, e As KeyPressEventArgs) Handles Me.KeyPress
        If e.KeyChar = Chr(Keys.Back) Then
            Intermediate.Label1.Text = "Press SPACE to start the level"
            Intermediate.Show()
            Intermediate.frm = "Level2"
            Me.Close()
        End If
    End Sub
